...
const WelcomePage = () => {
    ...
    const calorieCartText = "CalorieCart is an application that combines a grocery list builder and a calorie counter. That is you can interactively build a grocery list builder, that fits your needs, and we will tell you how that list would impact your diet. Choose how many days the grocery list should last you for, and then we will compare how the nutrition values of the created list stack up in comparison to healthy target values. Are you unhappy with your list, does it contain maybe too much sugar or too little fiber? Don't worry, we got you covered. Just use our search and filter functions to find products that will perfect your list. This way CalorieCart will allow you to develop healthier habits, and live a healthier life. Sounds good? Try it now!"
